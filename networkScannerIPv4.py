...
nx.draw_circular(graph_ihl, node_color='blue', node_size=10000, edge_color=colors_ihl, width=weights_ihl, with_labels=True, label='graph_ihl')
plt.show()
nx.draw_circular(graph_tos, node_color='blue', node_size=10000, edge_color=colors_tos, width=weights_tos, with_labels=True, label='graph_tos')
plt.show()
nx.draw_circular(graph_len, node_color='blue', node_size=10000, edge_color=colors_len, width=weights_len, with_labels=True, label='graph_len')
plt.show()
nx.draw_circular(graph_id, node_color='blue', node_size=10000, edge_color=colors_id, width=weights_id, with_labels=True, label='graph_id')
plt.show()
nx.draw_circular(graph_frag, node_color='blue', node_size=10000, edge_color=colors_frag, width=weights_frag, with_labels=True, label='graph_frag')
plt.show()
nx.draw_circular(graph_ttl, node_color='blue', node_size=10000, edge_color=colors_ttl, width=weights_ttl, with_labels=True, label='graph_ttl')
plt.show()
nx.draw_circular(graph_proto, node_color='blue', node_size=10000, edge_color=colors_proto, width=weights_proto, with_labels=True, label='graph_proto')
plt.show()
